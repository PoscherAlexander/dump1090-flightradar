var planeObject = {
    ...
    /**
     *  To remove the line from the screen if we deselect the plane
     */
    ...
    /**
     *  Creates an icon for us to use on the map
     */
    ...
    funcUpdateData: function(data) {
        ...
        // If no packet in over 58 seconds, consider the plane as reapable
        if (this.seen > 58) {
            this.reapable = true;
            if (this.marker) {
            ...
            if (SelectedPlaneOnTable == this.icao) {
                if (this.is_selected) {
                    this.is_selected = false;
                }
    ...
    funcUpdateMarker: function() {
        ...
        if (this.flight.length == 0) {
            ...
            this.marker.setTitle(this.flight);
        }
        return this.marker;
    },
